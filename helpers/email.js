...
let rescheduleUrl = config.get("client_url") + "/reschedule-appointment";
let cancelUrl = config.get("client_url") + "/cancel-appointment";
  ...
  ejs.renderFile(
    ...
    (err, data) => {
      if (err) {
        ...
        var mailOptions = {
          from: mailUser,
          to: "tinsofttechnologiesltd@gmail.com",
          subject: subject,
          html: data,
        };
...
const sendBookingEmail = async (
  ...
  const date = new Date().toLocaleDateString();
  ejs.renderFile(
    __dirname + "/templates/userAppointmentEmail.ejs",
    {
      receiver,
      subject,
      message,
